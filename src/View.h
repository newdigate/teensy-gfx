...
#ifndef __TEENSY_GFX_VIEW_H_
#define __TEENSY_GFX_VIEW_H_
...
#define tgfx_min(a, b) ((a < b)? a : b )
#define tgfx_max(a, b) ((a > b)? a : b )
...
public:
    View(unsigned short width, unsigned short height) :
        Print(),
        _width(width),
        _height(height)
    {
...
protected:
    ...
    inline void updateDisplayClip() {
        _displayclipx1 = tgfx_max(0, tgfx_min(_clipx1 + _originx, width()));
        _displayclipx2 = tgfx_max(0, tgfx_min(_clipx2 + _originx, width()));

        _displayclipy1 = tgfx_max(0, tgfx_min(_clipy1 + _originy, height()));
        _displayclipy2 = tgfx_max(0, tgfx_min(_clipy2 + _originy, height()));
